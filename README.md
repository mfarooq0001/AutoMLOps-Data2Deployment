# End-to-End Customer Satisfaction Prediction Pipeline with MlOps (ZenML, MlFlow)
...
- `clean_df`: This step will clean the data and remove the unwanted columns.
- `model_training`: This step will train the model and save the model using [MLflow autologging](https://www.mlflow.org/docs/latest/tracking.html).
- `model_evaluation`: This step will evaluate the model and save the metrics -- using MLflow autologging -- into the artifact store.
